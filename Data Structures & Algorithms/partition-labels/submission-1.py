class Solution:
    def partitionLabels(self, s: str) -> List[int]:
        ...
        What makes this algorithm greedy is this:

        When i == end, I know for a fact I can cut there without worrying about future possibilities.
        Therefore, I know at that point that that is the best decision and not worry about the future
        """
        result = []
        last_index = {}
